...
func (o *DcimConsoleConnectionsListParams) WithDeviceID(deviceID *int64) *DcimConsoleConnectionsListParams {
	o.SetDeviceID(deviceID)
	return o
}

// SetDeviceID adds the deviceId to the dcim console connections list params
func (o *DcimConsoleConnectionsListParams) SetDeviceID(deviceID *int64) {
	o.DeviceID = deviceID
}
