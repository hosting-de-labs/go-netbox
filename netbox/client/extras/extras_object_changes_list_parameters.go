...
func (o *ExtrasObjectChangesListParams) WithChangedObjectID(changedObjectID *int64) *ExtrasObjectChangesListParams {
	o.SetChangedObjectID(changedObjectID)
	return o
}

// SetChangedObjectID adds the changedObjectId to the extras object changes list params
func (o *ExtrasObjectChangesListParams) SetChangedObjectID(changedObjectID *int64) {
...
func (o *ExtrasObjectChangesListParams) WithID(id *int64) *ExtrasObjectChangesListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the extras object changes list params
func (o *ExtrasObjectChangesListParams) SetID(id *int64) {
	o.ID = id
}
...
func (o *ExtrasObjectChangesListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ChangedObjectID != nil {
		...
		var qrChangedObjectID int64
		if o.ChangedObjectID != nil {
			qrChangedObjectID = *o.ChangedObjectID
		}
		qChangedObjectID := swag.FormatInt64(qrChangedObjectID)
		if qChangedObjectID != "" {
