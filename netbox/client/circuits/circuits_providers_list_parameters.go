...
func (o *CircuitsProvidersListParams) WithRegionID(regionID *int64) *CircuitsProvidersListParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the circuits providers list params
func (o *CircuitsProvidersListParams) SetRegionID(regionID *int64) {
	o.RegionID = regionID
}
