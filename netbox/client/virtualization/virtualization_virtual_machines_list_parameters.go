...
func (o *VirtualizationVirtualMachinesListParams) WithVcpus(vcpus *int64) *VirtualizationVirtualMachinesListParams {
	o.SetVcpus(vcpus)
	return o
}

// SetVcpus adds the vcpus to the virtualization virtual machines list params
func (o *VirtualizationVirtualMachinesListParams) SetVcpus(vcpus *int64) {
	o.Vcpus = vcpus
}
